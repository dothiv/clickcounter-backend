...
class TestCase(unittest.TestCase):
    ...
    def test_money(self):
        ...
        self.assertEqual('0.1&cent;', util.Format('en').money(0.001))
        self.assertEqual('0.1&cent;', util.Format().money(0.001))
        ...
        self.assertEqual('1&cent;', util.Format('en').money(0.01))
        self.assertEqual('1&cent;', util.Format().money(0.01))
        ...
        self.assertEqual('99&cent;', util.Format('en').money(0.99))
        self.assertEqual('99&cent;', util.Format().money(0.99))
