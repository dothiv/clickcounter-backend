...
class TestCase(unittest.TestCase):
    ...
    def test_decimal_money(self):
        ...
        self.assertEquals('500.000 &euro;', util.Format('de').decimalMoney('500000'))
        self.assertEquals('&euro;500,000', util.Format('en').decimalMoney(500000))
        self.assertEquals('&euro;500,000', util.Format('en').decimalMoney('500000'))
        self.assertEquals('&euro;500,000', util.Format().decimalMoney(500000))
        self.assertEquals('&euro;500,000', util.Format().decimalMoney('500000'))
        self.assertEquals('500.000 &euro;', util.Format('es').decimalMoney('500000'))
        self.assertEquals('500.000 &euro;', util.Format('fr').decimalMoney('500000'))

    def test_money(self):
        self.assertEquals('500.000,00 &euro;', util.Format('de').money(500000))
        self.assertEquals('500.000,00 &euro;', util.Format('de').money('500000'))
        self.assertEquals('500.000,00 &euro;', util.Format('es').money('500000'))
        self.assertEquals('500.000,00 &euro;', util.Format('fr').money('500000'))
        self.assertEquals('&euro;500,000.00', util.Format('en').money(500000))
        self.assertEquals('&euro;500,000.00', util.Format('en').money('500000'))
        self.assertEquals('&euro;500,000.00', util.Format().money(500000))
        self.assertEquals('&euro;500,000.00', util.Format().money('500000'))
        self.assertEquals('0,1 ct', util.Format('de').money(0.001))
        self.assertEquals('0,1 ct', util.Format('es').money(0.001))
